...
export default function About() {
  ...
  return (
    <Layout>
      ...
      <section className="px-6 md:px-12 lg:px-24 py-16 md:py-20 dark:border-t dark:border-white/5 border-t border-black/5">
        <div className="max-w-3xl mx-auto space-y-16 font-space-grotesk">
          <div id="privacy" className="scroll-mt-28">
            <h2 className="font-oxanium text-xl md:text-2xl chrome-text mb-4 tracking-tight">Политика конфиденциальности</h2>
            <p className="text-sm dark:text-white/55 text-foreground/60 leading-relaxed mb-3">
              EstateofMind обрабатывает только те данные, которые вы добровольно передаёте при обращении
              (имя, контакт, параметры запроса). Мы не продаём и не передаём персональные данные третьим лицам
              для маркетинга. Переписка в WhatsApp/Telegram подчиняется правилам соответствующих платформ.
            </p>
            <p className="text-sm dark:text-white/55 text-foreground/60 leading-relaxed">
              Материалы сайта носят информационный характер и не являются публичной офертой.
              По вопросам данных: через контакты на этой странице.
            </p>
          </div>
          <div id="terms" className="scroll-mt-28">
            <h2 className="font-oxanium text-xl md:text-2xl chrome-text mb-4 tracking-tight">Пользовательское соглашение</h2>
            <p className="text-sm dark:text-white/55 text-foreground/60 leading-relaxed mb-3">
              Используя сайт, вы подтверждаете, что понимаете: объекты публикуются по данным агентств и бюро;
              цены и наличие требуют проверки на момент сделки. EstateofMind выступает посредником-консультантом
              и не является застройщиком или банком.
            </p>
            <p className="text-sm dark:text-white/55 text-foreground/60 leading-relaxed">
              Инвестиции в зарубежную недвижимость связаны с юридическими и рыночными рисками.
              Финальные условия фиксируются в договоре с продавцом/агентством и при необходимости — с юристом клиента.
            </p>
          </div>
        </div>
      </section>
