...
export const LISTINGS: Listing[] = [
  ...
  /* ── Dubai inventory lines via Fame Real Estate (fame-estate.com) ─
   * Site has no public unit grid; prices = current market averages for
   * projects they promote (Damac / Nakheel). Contact path: fame-estate.com
   * ─────────────────────────────────────────────────────────────── */

  {
    ...
    country: 'AE',
    city: 'Дубай',
    district: 'Business Bay · Damac Towers by Paramount',
    type: 'АПАРТАМЕНТЫ',
    price: '$440,000',
    pricePerSqm: '≈ $6,100/м²',
    beds: 1,
    ...
    image: '/images/dest-dubai.jpg',
    agency: 'EstateOfMind',
    agencyUrl: 'https://fame-estate.com/',
    exclusive: true,
    agencyPhotos: [],
    tags: ['Business Bay', 'Damac', 'Golden Visa'],
    crypto: true,
    locationMap: {
      image: mapDubaiBusinessBay,
      pinPos: { x: 50, y: 48 },
      accentColor: 'hsl(32,80%,48%)',
      distances: [
        { icon: 'landmark', label: 'До Бурдж-Халифы', minutes: 8 },
        { icon: 'center',   label: 'До DIFC',         minutes: 7 },
        { icon: 'sea',      label: 'До канала',       minutes: 5 },
      ],
    },
    description: '1 bedroom в комплексе Damac Towers by Paramount (Business Bay) — четыре башни смешанного назначения у канала. Средний рыночный уровень для 1BR: гостиная, en-suite, гостевой санузел, доступ к hotel-style amenities Paramount.',
    neighborhood: 'Business Bay — деловой пояс между Downtown и DIFC, сильный корпоративный и туристический спрос на аренду.',
    legalFit: '≈$440k — выше порога 2-летней residency visa; до 10-летней Golden Visa ($545k+) — уточняйте актуальный порог и возможность добора.',
    yieldEstimate: '6–8% при краткосрочной аренде в Business Bay; долгосрочная 5–6%.',
    riskNote: 'Сервисные сборы branded tower выше среднего; закладывайте service charge в ROI.',
  },

  {
    ...
    exclusive: true,
    agencyPhotos: [],
    tags: ['2BR', 'Paramount', 'Business Bay'],
    crypto: true,
    locationMap: {
      image: mapDubaiBusinessBay,
      pinPos: { x: 52, y: 46 },
      accentColor: 'hsl(28,75%,46%)',
      distances: [
        { icon: 'landmark', label: 'До Бурдж-Халифы', minutes: 8 },
        { icon: 'mall',     label: 'До Dubai Mall',   minutes: 10 },
        { icon: 'center',   label: 'До DIFC',         minutes: 7 },
      ],
    },
    description: '2 bedroom уровень Damac Towers by Paramount — просторная планировка, 2–3 санузла, вид на Business Bay / Creek в зависимости от башни и этажа. Семейный или корпоративный формат аренды.',
    neighborhood: 'Business Bay держит одну из самых плотных баз корпоративных арендаторов в Дубае.',
    legalFit: 'Выше порога Golden Visa ($545k) — 10-летнее резидентство для семьи при соответствии правилам DLD/GDRFA.',
    yieldEstimate: '5,5–7,5% валовой при управлении; 2BR в BB стабильно сдаётся.',
    riskNote: 'Конкуренция нового stock в Business Bay ограничивает рост цены на вторичке.',
  },

  {
    ...
    country: 'AE',
    city: 'Дубай',
    district: 'Downtown · Damac Maison The Distinction',
    type: 'АПАРТАМЕНТЫ',
    price: '$422,000',
    pricePerSqm: '≈ $5,800/м²',
    beds: 1,
    ...
    exclusive: true,
    agencyPhotos: [],
    tags: ['Downtown', 'Furnished', 'Damac Maison'],
    crypto: false,
    locationMap: {
      image: mapDubaiDowntown,
      pinPos: { x: 50, y: 46 },
      accentColor: 'hsl(45,95%,55%)',
      distances: [
        { icon: 'landmark', label: 'До Бурдж-Халифы', minutes: 5 },
        { icon: 'mall',     label: 'До Dubai Mall',   minutes: 6 },
        { icon: 'center',   label: 'До Opera District', minutes: 4 },
      ],
    },
    description: '1 bedroom в Damac Maison The Distinction (Downtown) — serviced/maison формат у Бурдж-Халифы. Рыночный уровень 1BR ~767–918 sq.ft; часто с мебелью и hotel-style сервисом.',
    neighborhood: 'Downtown Dubai — максимальная ликвидность и узнаваемость адреса в эмирате.',
    legalFit: 'Ниже Golden Visa порога; 2-летняя residency visa по недвижимости доступна при соответствии сумме.',
    yieldEstimate: '6–8% краткосрочная с видом/локацией Downtown; долгосрочная 4,5–5,5%.',
    riskNote: 'Высокий service charge branded maison; проверяйте ROI после fees.',
  },

  {
    ...
    locationMap: {
      ...
      distances: [
        { icon: 'landmark', label: 'До Бурдж-Халифы', minutes: 5 },
        { icon: 'mall',     label: 'До Dubai Mall',   minutes: 6 },
        { icon: 'center',   label: 'До DIFC',         minutes: 10 },
      ],
    },
    description: '2 bedroom уровень Damac Maison The Distinction — средний рынок ~1,238–1,430 sq.ft. Подходит семье или под корпоративную аренду в Downtown.',
    neighborhood: 'Downtown: Opera, Fountain Views, Dubai Mall — круглогодичный спрос.',
    legalFit: 'Выше Golden Visa порога — 10-летнее резидентство при выполнении условий сделки.',
    yieldEstimate: '5–7% валовой при профессиональном управлении.',
    riskNote: 'Перегрев предложения в Downtown; горизонт владения лучше 3–5+ лет.',
  },

  {
    ...
    country: 'AE',
    city: 'Дубай',
    district: 'Damac Hills · Damac District',
    type: 'АПАРТАМЕНТЫ',
    price: '$358,000',
    pricePerSqm: '≈ $3,400/м²',
    beds: 2,
    ...
    exclusive: true,
    agencyPhotos: [],
    tags: ['Damac Hills', 'Golf', 'Payment plan'],
    crypto: true,
    locationMap: {
      image: mapDubaiRanches,
      pinPos: { x: 48, y: 52 },
      accentColor: 'hsl(88,55%,38%)',
      distances: [
        { icon: 'landmark', label: 'До гольф-поля', minutes: 5 },
        { icon: 'mall',     label: 'До ТЦ района',  minutes: 8 },
        { icon: 'center',   label: 'До Downtown',   minutes: 30 },
      ],
    },
    description: '2 bedroom в Damac District / Damac Hills — master-planned сообщество с гольфом. Рыночный уровень ~AED 1.3–1.8M для 2BR; часто с payment plan от застройщика.',
    neighborhood: 'Damac Hills — семейный пригород с гольфом и парками, ниже плотность, чем Marina/Downtown.',
    legalFit: 'Вход ниже Golden Visa; 2-летняя visa при соответствии сумме. Уточняйте off-plan vs ready.',
    yieldEstimate: '6–8% при долгосрочной семейной аренде; краткосрочная слабее, чем на набережной.',
    riskNote: 'Дальше от центра — ликвидность ниже Marina; проверяйте срок сдачи, если off-plan.',
  },

  {
    ...
    country: 'AE',
    city: 'Дубай',
    district: 'Damac Hills · Golf Greens',
    type: 'АПАРТАМЕНТЫ',
    price: '$316,000',
    pricePerSqm: '≈ $4,200/м²',
    beds: 1,
    ...
    exclusive: true,
    agencyPhotos: [],
    tags: ['Golf view', '1BR', 'Damac Hills'],
    crypto: false,
    locationMap: {
      image: mapDubaiRanches,
      pinPos: { x: 46, y: 50 },
      accentColor: 'hsl(100,45%,40%)',
      distances: [
        { icon: 'landmark', label: 'До fairway',   minutes: 3 },
        { icon: 'mall',     label: 'До ТЦ',        minutes: 10 },
        { icon: 'center',   label: 'До Downtown',  minutes: 32 },
      ],
    },
    description: '1 bedroom с видом на гольф в Golf Greens / Damac Hills — входной уровень в master-planned Damac. Подходит инвестору, которому важнее yield и спокойствие, чем marina-адрес.',
    neighborhood: 'Akoya / Damac Hills — зелёный пригород, ориентир на семьи и mid-term аренду.',
    legalFit: 'Ниже Golden Visa; residency visa 2 года при выполнении порога по сумме.',
    yieldEstimate: '6–9% при стабильной долгосрочной аренде.',
    riskNote: 'Пригородный спрос чувствителен к ставкам и новому stock поблизости.',
  },

  {
    ...
    exclusive: true,
    agencyPhotos: [],
    tags: ['Studio', 'Paramount', 'Высокий ROI'],
    crypto: true,
    locationMap: {
      image: mapDubaiBusinessBay,
      pinPos: { x: 49, y: 50 },
      accentColor: 'hsl(20,70%,48%)',
      distances: [
        { icon: 'sea',      label: 'До канала',       minutes: 5 },
        { icon: 'landmark', label: 'До Бурдж-Халифы', minutes: 9 },
        { icon: 'center',   label: 'До DIFC',         minutes: 8 },
      ],
    },
    description: 'Studio в Damac Towers by Paramount — компактный формат под аренду. Средний рынок studio ~AED 1.05M; высокая оборачиваемость у singles и digital nomads.',
    neighborhood: 'Business Bay studio stock быстро сдаётся корпоративным и туристическим спросом.',
    legalFit: 'Ниже residency-порогов для 10-летней визы; 2-летняя — при соответствии минимальной сумме DLD.',
    yieldEstimate: '7–10% при краткосрочной аренде; один из самых высоких ROI-форматов в BB.',
    riskNote: 'Малая площадь: чувствительность к service charge и простою между гостями.',
  },

  {
    ...
    country: 'AE',
    city: 'Дубай',
    district: 'Palm Jumeirah · Nakheel community',
    type: 'АПАРТАМЕНТЫ',
    price: '$780,000',
    pricePerSqm: '≈ $7,800/м²',
    beds: 2,
    ...
    locationMap: {
      ...
      accentColor: 'hsl(27,85%,46%)',
      distances: [
        { icon: 'sea',      label: 'До пляжа',     minutes: 2 },
        { icon: 'landmark', label: 'До Atlantis',  minutes: 8 },
        { icon: 'mall',     label: 'До Nakheel Mall', minutes: 6 },
      ],
    },
    description: '2 bedroom на Palm Jumeirah в линейке сообществ Nakheel — премиальный островной формат с пляжем и закрытой инфраструктурой. Fame работает с Nakheel-проектами; точный корпус/вид согласуется при запросе.',
    neighborhood: 'Palm Jumeirah — ультра-премиум, ограниченный land bank, сильный HNW-спрос.',
    legalFit: 'Выше Golden Visa порога — 10-летнее резидентство для семьи при выполнении условий.',
    yieldEstimate: '4–6% долгосрочная; краткосрочная выше, но с ограничениями управляющих компаний острова.',
    riskNote: 'Высокий вход и service fees; горизонт продажи 6–12 месяцев в этом ценовом диапазоне.',
  },
