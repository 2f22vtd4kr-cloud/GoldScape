...
export const COUNTRIES: CountryData[] = [
  ...
  },
  {
    ...
    stats: [
      ...
      { value: '$150K',  label: 'порог для ВНЖ' },
    ],
    features: [
      {
    ...
    visa:    'ВНЖ инвестора от $150,000 (порог повышен с 1 марта 2026). ВНЖ через регистрацию ИП (оборот от 50,000 GEL). Безвиз 365 дней для граждан РФ.',
  ...
  {
    code: 'me', listingCode: 'ME', flag: '',
    nameRu: 'Черногория', nameEn: 'Montenegro',
    capital: 'Котор',
    currency: 'EUR',
    entryPrice: 'от €174,900',
    mapImage: mapMontenegro,
    tagline: 'Адриатическая жемчужина. Простой ВНЖ и нулевые барьеры на вход.',
    stats: [
      { value: '9%',      label: 'плоский подоходный налог' },
      { value: '0%',      label: 'налог на прирост капитала (>2 лет)' },
      { value: '30 дней', label: 'срок оформления ВНЖ' },
    ],
    features: [
      {
        title: 'Простой ВНЖ за недвижимость',
        body:  'Покупка объекта любой стоимости — основание для оформления временного вида на жительство. Без минимального порога инвестиций, без требований к доходу. Документы подаются в полиции по месту регистрации.',
      },
      {
        title: 'Адриатика и ЮНЕСКО',
        body:  'Залив Котор — единственный фьорд Адриатики, объект Всемирного наследия ЮНЕСКО. Свети-Стефан, Будванская ривьера и Которские стены — первый класс для жизни и аренды.',
      },
      {
        title: 'Путь к ЕС',
        body:  'Черногория — кандидат на вступление в ЕС, правовая система гармонизируется с европейскими стандартами. Евро как официальная валюта с 2002 года: вход и выход без курсового риска.',
      },
    ],
    markets: [
      { city: 'Котор · Доброта',       priceFrom: '€943,800', highlight: 'Первая линия, залив UNESCO, тихий премиум-сегмент' },
      { city: 'Будва · Свети-Стефан',  priceFrom: '€174,900', highlight: 'Вид на иконический остров, 5% арендный потенциал' },
      { city: 'Тиват · Porto Montenegro', priceFrom: '€350,000', highlight: 'Яхтенная марина, инфраструктура 5*, быстрый аэропорт' },
    ],
    visa:    'Временный ВНЖ за покупку любой жилой недвижимости — без минимальной суммы. ПМЖ после 5 лет ВНЖ. Программа CBI (гражданство за инвестиции) приостановлена с декабря 2022 года.',
    taxNote: 'Налог на передачу при покупке — 3%. Подоходный налог на аренду — 9%. Прирост капитала при продаже после 2 лет владения — 0%. НДС на новое строительство — 21%.',
  },
];
